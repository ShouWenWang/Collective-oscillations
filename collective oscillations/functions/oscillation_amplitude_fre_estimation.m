function [rela_unc_mean_fre,rela_unc_mean_amp,fre_final,amp_final]=oscillation_amplitude_fre_estimation(h,dt,T0,T_min,plot_on)
...
%%
T_ini=90; % delete the transient period
L=T0/dt;
