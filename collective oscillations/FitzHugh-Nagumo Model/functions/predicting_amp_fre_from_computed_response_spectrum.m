...
%Rh_fre1=@(sigma) 1./(wh-sqrt(-1)*sigma); % linear version 
...
%output_name="./data/"+aa+"_predicted_amp_fre_"+num2str(floor(10*rand()));
output_name="./data/predicted_amp_fre";
save(output_name);
