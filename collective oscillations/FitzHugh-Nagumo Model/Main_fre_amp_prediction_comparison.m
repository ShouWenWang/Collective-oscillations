...
%N_array=0.8:0.05:3; % range of the effective coupling used inthe paper
N_array=[1 1.2]; % test
...
% output_name="./data/"+aa+"_amp_fre_predicted_comparison"+num2str(floor(10*rand()));
output_name="./data/amp_fre_predicted_comparison";
save(output_name);

else
    load ./data/amp_fre_predicted_comparison
