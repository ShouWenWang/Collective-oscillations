...
figureParameter
f1=semilogx(omega,angle(Rh_fre1(omega,10)),'*r',omega,angle(Rh_fre1(omega,1)),'og',omega,angle(Rh_fre1(omega,0.1)),'sk',omega1,-angle(Rx_fre_epsilon(omega1,0.01)),'-b');
a1=xlabel('$\omega$');
xlim([0.001 100]);
ylim([0,1.6]);
set(gca,'Ytick',[0 1.6]);
...
plot_on=1;
[time,h,x_bar,heat_rate_h]=generating_collective_motion_feedback_adaptation(T0,dt,N,epsilon,alpha_10,wh_nonlinear,wx_nonlinear,plot_on);
