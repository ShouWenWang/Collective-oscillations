function [dt,T0,s_in,s_ex]=minimum_glycolysis_step_perturbation(dt,T0,D,s_ex_0,plot_fig)

%[dt,T0,s_in,s_ex]=minimum_glycolysis_step_perturbation(phi,s_ex_0)
...
s_ex=zeros(L,1)+s_ex_0;
s_ex(floor(9.1/dt):end)=s_ex_0*1.1; %  10 percent increase
